...
//! - `regex` feature: Uses regex crate for digit extraction
//! - `ffi_pcre2` feature: (TODO) Uses pcre2 via FFI
...
// ============================================================================
// FFI PCRE2 implementation (placeholder for later)
// ============================================================================

#[cfg(feature = "ffi_pcre2")]
pub mod pcre2_impl {
    // TODO: Implement using pcre2 FFI similar to day-01's C interop
    // extern "C" { ... }

    pub fn part1(_input: &str) -> u32 {
        todo!("pcre2 FFI implementation")
    }
